...
const features = [
  {
    ...
    description: "Vitamin E and jojoba oil keep lips soft and moisturized all day.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: "Non-Sticky",
    description: "Lightweight texture that feels like nothing on your lips.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: "Glass-like shine that catches light beautifully.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: "Subtle Scents",
    description: "Delicate fragrances that complement, never overpower.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: "100% Vegan",
    description: "No animal products, no animal testing. Ever.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: "Cruelty-Free",
    description: "Leaping Bunny certified. Beauty without compromise.",
  },
];
